      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-white/70 mb-12 leading-relaxed max-w-3xl mx-auto font-light">
            Soluções contábeis e tributárias estratégicas para empresas e 
            indivíduos que exigem o mais alto padrão de excelência profissional.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-8">
            ...
            <a
              ...
              className="group bg-green-500 text-white px-10 py-4 rounded-sm font-medium text-lg transition-all duration-300 hover:bg-green-600 flex items-center space-x-3"
            >
